...
import ec.edu.monster.facade.PerfilFacade;
...
public class PerfilController implements Serializable {
    ...
    @EJB
    private ec.edu.monster.facade.PerfilFacade ejbFacade;
    ...
    public Perfil getPerfil(java.lang.String id) {
    ...
    public static class PerfilControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Perfil) {
                ...
                return getStringKey(o.getSeperCodigo());
            } else {
