...
import ec.edu.monster.facade.UsuarioFacade;
...
public class UsuarioController implements Serializable {
    ...
    @EJB
    private ec.edu.monster.facade.UsuarioFacade ejbFacade;
    ...
    public String iniciarSesion() {
        ...
        //boolean ced = false;
        try {
            usu = getFacade().iniciarSesion(current);
            //ced = validadorDeCedula(usu.getPeempCedula());
            if (usu != null) {
    ...
    public void verificarSesion() {
        try {
            ...
            current = (Usuario) context.getExternalContext().getSessionMap().get("usuario");
            if (current == null) {
...
///METODOS POR DEFECTO////////////////////////////////////////////////////
    ...
    public String create() {
        try {
            ...
            current.setSeusuFechacreacion(ahora);
            current.setSeusuFechaultimocambio(ahora);
            current.setSeusuContrasena(DigestUtils.sha512Hex(current.getSeusuContrasena()));
    ...
    public static class UsuarioControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Usuario) {
                ...
                return getStringKey(o.getSeusuUsuario());
            } else {
