...
import ec.edu.monster.facade.ProvinciaFacade;
...
public class ProvinciaController implements Serializable {
    ...
    @EJB
    private ec.edu.monster.facade.ProvinciaFacade ejbFacade;
    ...
    public Provincia getProvincia(java.lang.String id) {
    ...
    public static class ProvinciaControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Provincia) {
                ...
                return getStringKey(o.getPeprovCodigo());
            } else {
