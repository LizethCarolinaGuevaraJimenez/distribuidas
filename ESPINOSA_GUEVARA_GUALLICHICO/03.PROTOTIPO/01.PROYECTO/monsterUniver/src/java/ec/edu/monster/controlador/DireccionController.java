...
import ec.edu.monster.facade.DireccionFacade;
...
public class DireccionController implements Serializable {
    ...
    @EJB
    private ec.edu.monster.facade.DireccionFacade ejbFacade;
    ...
    public Direccion getDireccion(java.lang.String id) {
    ...
    public static class DireccionControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Direccion) {
                ...
                return getStringKey(o.getPedirCodigo());
            } else {
