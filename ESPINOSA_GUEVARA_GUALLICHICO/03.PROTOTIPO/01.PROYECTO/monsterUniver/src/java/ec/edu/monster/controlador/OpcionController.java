...
import ec.edu.monster.facade.OpcionFacade;
...
public class OpcionController implements Serializable {
    ...
    @EJB
    private ec.edu.monster.facade.OpcionFacade ejbFacade;
    ...
    public static class OpcionControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Opcion) {
                ...
                return getStringKey(o.getSeopcCodigo());
            } else {
