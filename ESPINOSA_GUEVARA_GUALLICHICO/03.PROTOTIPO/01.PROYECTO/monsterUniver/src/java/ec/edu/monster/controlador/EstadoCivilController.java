...
import ec.edu.monster.facade.EstadoCivilFacade;
...
public class EstadoCivilController implements Serializable {
    ...
    @EJB
    private ec.edu.monster.facade.EstadoCivilFacade ejbFacade;
    ...
    public EstadoCivil getEstadoCivil(java.lang.String id) {
    ...
    public static class EstadoCivilControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof EstadoCivil) {
                ...
                return getStringKey(o.getPeestCodigo());
            } else {
