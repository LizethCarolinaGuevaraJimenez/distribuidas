...
public class DetalleOrdenController implements Serializable {
    ...
    public DetalleOrden getSelected() {
        if (current == null) {
            ...
            current.setDetalleOrdenPK(new ec.edu.monster.modelo.DetalleOrdenPK());
            selectedItemIndex = -1;
        }
        return current;
    }
    ...
    public String create() {
        try {
            current.getDetalleOrdenPK().setCeordNumero(current.getOrdenContractual().getCeordNumero());
            current.getDetalleOrdenPK().setMebieId(current.getItemSolicitud().getItemSolicitudPK().getMebieId());
            current.getDetalleOrdenPK().setCesolNumero(current.getItemSolicitud().getItemSolicitudPK().getCesolNumero());
    ...
    public static class DetalleOrdenControllerConverter implements Converter {
        ...
        ec.edu.monster.modelo.DetalleOrdenPK getKey(String value) {
            ...
            key.setCeordNumero(values[0]);
            key.setCesolNumero(values[1]);
        ...
        String getStringKey(ec.edu.monster.modelo.DetalleOrdenPK value) {
            ...
            sb.append(value.getCeordNumero());
            sb.append(SEPARATOR);
