...
public class ItemEntradaController implements Serializable {
    ...
    public String create() {
        try {
            current.getItemEntradaPK().setEntNumero(current.getEntradaAlmacen().getEntNumero());
            current.getItemEntradaPK().setBienId(current.getBienes().getBienId());
    ...
    public static class ItemEntradaControllerConverter implements Converter {
        ...
        ec.edu.monster.modelo.ItemEntradaPK getKey(String value) {
            ...
            key.setBienId(values[0]);
            key.setEntNumero(values[1]);
            return key;
        }
