...
import ec.edu.monster.facade.EntradaAlmacenFacade;
...
public class EntradaAlmacenController implements Serializable {
    ...
    private EntradaAlmacen current;
    private DataModel items = null;
    @EJB
    private ec.edu.monster.facade.EntradaAlmacenFacade ejbFacade;
    ...
    public String prepareView() {
        current = (EntradaAlmacen) getItems().getRowData();
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("EntradaAlmacenCreated"));
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("EntradaAlmacenUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("EntradaAlmacenDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
        }
    }
    ...
    public EntradaAlmacen getEntradaAlmacen(java.lang.String id) {
    ...
    public static class EntradaAlmacenControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof EntradaAlmacen) {
                ...
                return getStringKey(o.getEntNumero());
            } else {
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + EntradaAlmacen.class.getName());
            }
        }
